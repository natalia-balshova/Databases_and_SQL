...
INSERT INTO `shops`
VALUES  (1, "Четыре лапы"), (2, "Мистер Зоо"), (3, "МурзиЛЛа"), (4, "Кошки и собаки");

INSERT INTO `cats`
VALUES ("Murzik", 1, 1), ("Nemo", 2, 2), ("Vicont", 3, 1), ("Zuza", 4, 3);
...
SELECT shopname
FROM shops
WHERE shops.id NOT IN (SELECT shops_id FROM cats WHERE name = "Zuza" OR name = "Murzik");
...
VALUES 
    ...
    SELECT Analysis.an_name, Analysis.an_price FROM Orders
    LEFT JOIN Analysis
    ...
    -- Не нашла по условию, нужно ли присоединять таблицу GroupsAn, на всякий случай присоединила и вывела название группы
    
    -- Вся таблица без фильтров
    SELECT * FROM Orders
    LEFT JOIN Analysis
    ON Analysis.an_id = Orders.ord_an
    LEFT JOIN GroupsAn
